...
import '../../../model/all_seed_model.dart';
import '../../../model/cart_model.dart';
import '../../cart/cart_screen.dart';

class SeedDetailsScreen extends StatefulWidget {
  ProductModel productModel;
  SeedDetailsScreen({super.key, required this.productModel});

  @override
  State<SeedDetailsScreen> createState() => _ProductDetailsScreenState();
}

class _ProductDetailsScreenState extends State<SeedDetailsScreen> {
